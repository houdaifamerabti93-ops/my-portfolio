    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/10 backdrop-blur-md mb-8 hover:border-[#00e5ff]/40 transition-colors"
        >
        ...
        <motion.p
          ...
          className="max-w-2xl text-base sm:text-xl text-[#8892b0] font-normal leading-relaxed mb-10"
        >
        ...
        <motion.div
          ...
          className="hidden sm:inline-flex items-center gap-4 px-4 py-2 rounded-full bg-white/[0.02] border border-white/[0.06] text-xs font-mono text-[#8892b0]"
        >
