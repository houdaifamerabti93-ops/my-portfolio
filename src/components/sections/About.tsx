      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center relative z-10">
            {/* LEFT COLUMN: Visual & Professional Photo Card */}
            <motion.div variants={itemVariants} className="lg:col-span-5 flex justify-center w-full">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-7 space-y-6 sm:space-y-7">
              {/* Section Label */}
              <div>
                ...
                <h2 className="font-heading text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.1]">
                  Hi, I'm{' '}
                ...
                <p className="font-heading text-lg sm:text-xl font-semibold text-[#00e5ff] mt-2 flex items-center gap-2">
              ...
              <div className="space-y-4 text-sm sm:text-base text-[#8892b0] leading-relaxed">
                {/* Para 1: Who I am (5+ years building web apps) */}
                <p>
                ...
                {/* Para 2: What I love (fast, modern, immersive experiences) */}
                <p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 pt-4 border-t border-white/[0.08]">
                {stats.map((stat, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-[#00e5ff]/10 text-[#00e5ff] flex items-center justify-center mb-2.5 group-hover:scale-110 transition-transform">
